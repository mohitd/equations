...
public class DbUtils {
    ...
    /**
     * Calls {@link #executeSqlScript(android.content.Context, android.database.sqlite.SQLiteDatabase, String, boolean)}
    ...
    private static int executeSqlStatementsInTx(SQLiteDatabase db,
            String[] statements) {
        db.beginTransaction();
        try {
    ...
    private static int executeSqlStatements(SQLiteDatabase db,
            String[] statements) {
        int count = 0;
