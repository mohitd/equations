 ...
 * 
 */
public class VelocityEquActivity extends FormulaActivity {
    public static final String ACTION_VELOCITY_EQU = "com.centauri.equations.action.VELOCITY_EQU";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new VelocityEquFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.velocity_equ);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class VelocityEquFragment extends FormulaFragment {

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
	    super.onActivityCreated(savedInstanceState);
	    ((ImageView) getView().findViewById(R.id.img_formula))
		    .setImageResource(R.drawable.img_phy_velocity_equations);
	}
