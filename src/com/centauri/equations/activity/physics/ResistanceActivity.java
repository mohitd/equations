...
public class ResistanceActivity extends FormulaActivity {

    public static final String ACTION_RESISTANCE = "com.centauri.equations.action.RESISTANCE";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new ResistanceFragment()).commit();
    }
    ...
    public static class ResistanceFragment extends FormulaFragment {

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
	    super.onActivityCreated(savedInstanceState);
	    ((ImageView) getView().findViewById(R.id.img_formula))
		    .setImageResource(R.drawable.img_phy_resistance);
	}
