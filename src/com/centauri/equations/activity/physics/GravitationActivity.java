...
public class GravitationActivity extends FormulaActivity {
	...
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new GravitationFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.universal_gravitation);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class GravitationFragment extends FormulaFragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    ((ImageView) getView().findViewById(R.id.img_area))
		    .setImageResource(R.drawable.img_phy_gravitation);
	    ...
	    adapter = ArrayAdapter.createFromResource(getActivity(),
		    R.array.gravitation, android.R.layout.simple_spinner_item);
	...
	public void onItemSelected(AdapterView<?> parent, View view,
	    ...
	    if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[0])) {
		a_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[1]);
		b_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[2]);
		c_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[3]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[1])) {
		a_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[0]);
		b_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[2]);
		c_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[3]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[2])) {
		a_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[0]);
		b_txt.setHint(getResources()
			.getStringArray(R.array.gravitation)[1]);
	...
	public void onClick(View v) {
	    ...
	    if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[0])) {
		result = Physics.universalGravitation(Double.NEGATIVE_INFINITY,
			a, b, c);

	    } else if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[1])) {
		result = Physics.universalGravitation(a,
			Double.NEGATIVE_INFINITY, b, c);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[2])) {
		result = Physics.universalGravitation(a, b,
			Double.NEGATIVE_INFINITY, c);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.gravitation)[3])) {
		result = Physics.universalGravitation(a, b, c,
