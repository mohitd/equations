...
public class MomentumActivity extends FormulaActivity {

    public static final String ACTION_MOMENTUM = "com.centauri.equations.action.MOMENTUM";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new MomentumFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.momentum);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class MomentumFragment extends FormulaFragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    ((ImageView) getView().findViewById(R.id.img_area))
		    .setImageResource(R.drawable.img_phy_momentum);

	    a_txt = ((EditText) getView().findViewById(R.id.area_a));
	    b_txt = ((EditText) getView().findViewById(R.id.area_b));

	    a_txt.setHint(getResources().getStringArray(R.array.momentum)[1]);
	    b_txt.setHint(getResources().getStringArray(R.array.momentum)[2]);
	    ((EditText) getView().findViewById(R.id.area_c))
		    .setVisibility(View.GONE);

	    adapter = ArrayAdapter.createFromResource(getActivity(),
		    R.array.momentum, android.R.layout.simple_spinner_item);
	...
	public void onItemSelected(AdapterView<?> parent, View view,
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.momentum)[0])) {
		a_txt.setHint(getResources().getStringArray(R.array.momentum)[1]);
		b_txt.setHint(getResources().getStringArray(R.array.momentum)[2]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.momentum)[1])) {
		a_txt.setHint(getResources().getStringArray(R.array.momentum)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.momentum)[2]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.momentum)[2])) {
		a_txt.setHint(getResources().getStringArray(R.array.momentum)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.momentum)[1]);
	    }
	}
	...
	public void onClick(View v) {
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.momentum)[0])) {
		result = Physics.momentum(Double.NEGATIVE_INFINITY, a, b);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.momentum)[1])) {
		result = Physics.momentum(a, Double.NEGATIVE_INFINITY, b);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.momentum)[2])) {
		result = Physics.momentum(a, b, Double.NEGATIVE_INFINITY);
	    }
