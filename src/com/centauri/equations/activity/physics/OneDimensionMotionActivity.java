...
public class OneDimensionMotionActivity extends FormulaActivity {

    public static final String ACTION_1D_MOTION = "com.centauri.equations.action.1D_MOTION";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportFragmentManager().beginTransaction()
                .add(android.R.id.content, new OneDimensionMotionFragment())
                .commit();
    }
    ...
    protected void setupActionBar() {
        ...
        getSupportActionBar().setTitle(R.string.one_dimensional_motion);
        getSupportActionBar().setSubtitle(
                getResources().getStringArray(R.array.categories)[4]);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class OneDimensionMotionFragment extends FormulaFragment
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            ((ImageView) getView().findViewById(R.id.img_area))
                    .setImageResource(R.drawable.img_phy_1d_motion);
            ...
            a_txt.setHint(getResources().getStringArray(R.array.dim1_motion)[1]);
            b_txt.setHint(getResources().getStringArray(R.array.dim1_motion)[2]);
            c_txt.setHint(getResources().getStringArray(R.array.dim1_motion)[3]);
            c_txt.setVisibility(View.VISIBLE);

            adapter = ArrayAdapter.createFromResource(getActivity(),
                    R.array.dim1_motion, android.R.layout.simple_spinner_item);
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[0])) {
                a_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[1]);
                b_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[2]);
                c_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[3]);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[1])) {
                a_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[0]);
                b_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[2]);
                c_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[3]);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[2])) {
                a_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[0]);
                b_txt.setHint(getResources()
                        .getStringArray(R.array.dim1_motion)[1]);
        ...
        public void onClick(View v) {
            ...
            if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[0])) {
                result = Physics.velocity(Double.NEGATIVE_INFINITY, a, b, c);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[1])) {
                result = Physics.velocity(a, Double.NEGATIVE_INFINITY, b, c);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[2])) {
                result = Physics.velocity(a, b, Double.NEGATIVE_INFINITY, c);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.dim1_motion)[3])) {
                result = Physics.velocity(a, b, c, Double.NEGATIVE_INFINITY);
            }
