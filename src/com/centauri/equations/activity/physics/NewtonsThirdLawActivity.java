 ...
 * 
 */
public class NewtonsThirdLawActivity extends FormulaActivity {
    public static final String ACTION_NEWTONS_3_LAW = "com.centauri.equations.action.NEWTONS_3_LAW";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new Newtons3LawFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.newtons_third_law);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class Newtons3LawFragment extends FormulaFragment {

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
	    super.onActivityCreated(savedInstanceState);
	    ((ImageView) getView().findViewById(R.id.img_formula))
		    .setImageResource(R.drawable.img_phy_newtons_third_law);
	}
