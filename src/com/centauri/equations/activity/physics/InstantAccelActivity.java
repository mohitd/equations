 ...
 * 
 */
public class InstantAccelActivity extends FormulaActivity {
    public static final String ACTION_INSTANT_ACCEL = "com.centauri.equations.action.INSTANT_ACCEL";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new InstantAccelFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.instantaneous_accel);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class InstantAccelFragment extends FormulaFragment {

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
	    super.onActivityCreated(savedInstanceState);
	    ((ImageView) getView().findViewById(R.id.img_formula))
		    .setImageResource(R.drawable.img_phy_instantaneous_acceleration);
	}
