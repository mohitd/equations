    ...
    public static class WorkFragment extends FormulaFragment implements
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            ((ImageView) getView().findViewById(R.id.img_area))
                    .setImageResource(R.drawable.img_phy_work);

            a_txt = ((EditText) getView().findViewById(R.id.area_a));
            b_txt = ((EditText) getView().findViewById(R.id.area_b));

            a_txt.setHint(getResources().getStringArray(R.array.work)[1]);
            b_txt.setHint(getResources().getStringArray(R.array.work)[2]);
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (variable.equals(getResources().getStringArray(R.array.work)[0])) {
                a_txt.setHint(getResources().getStringArray(R.array.work)[1]);
                b_txt.setHint(getResources().getStringArray(R.array.work)[2]);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.work)[1])) {
                a_txt.setHint(getResources().getStringArray(R.array.work)[0]);
                b_txt.setHint(getResources().getStringArray(R.array.work)[2]);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.work)[2])) {
                a_txt.setHint(getResources().getStringArray(R.array.work)[0]);
                b_txt.setHint(getResources().getStringArray(R.array.work)[1]);
            }
        }
        ...
        public void onClick(View v) {
            ...
            if (variable.equals(getResources().getStringArray(R.array.work)[0])) {
                result = Physics.work(Double.NEGATIVE_INFINITY, a, b);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.work)[1])) {
                result = Physics.work(a, Double.NEGATIVE_INFINITY, b);
            } else if (variable.equals(getResources().getStringArray(
                    R.array.work)[2])) {
                result = Physics.work(a, b, Double.NEGATIVE_INFINITY);
            }
