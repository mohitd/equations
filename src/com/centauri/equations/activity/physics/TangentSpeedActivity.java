 ...
 * 
 */
public class TangentSpeedActivity extends FormulaActivity {

    public static final String ACTION_TANGENT_SPEED = "com.centauri.equations.action.TANGENT_SPEED";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportFragmentManager().beginTransaction()
                .add(android.R.id.content, new TangentSpeedFragment()).commit();
    }
    ...
    protected void setupActionBar() {
        ...
        getSupportActionBar().setTitle(R.string.tangent_speed);
        getSupportActionBar().setSubtitle(
                getResources().getStringArray(R.array.categories)[4]);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class TangentSpeedFragment extends FormulaFragment {

        @Override
        public void onActivityCreated(Bundle savedInstanceState) {
            super.onActivityCreated(savedInstanceState);
            ((ImageView) getView().findViewById(R.id.img_formula))
                    .setImageResource(R.drawable.img_phy_tangential_speed);
        }
