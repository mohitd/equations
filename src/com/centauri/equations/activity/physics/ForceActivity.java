...
public class ForceActivity extends FormulaActivity {

    public static final String ACTION_FORCE = "com.centauri.equations.action.FORCE";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new ForceFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.force);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class ForceFragment extends FormulaFragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    ((ImageView) getView().findViewById(R.id.img_area))
		    .setImageResource(R.drawable.img_phy_newtons_laws);

	    a_txt = ((EditText) getView().findViewById(R.id.area_a));
	    b_txt = ((EditText) getView().findViewById(R.id.area_b));

	    a_txt.setHint(getResources().getStringArray(R.array.force)[1]);
	    b_txt.setHint(getResources().getStringArray(R.array.force)[2]);
	...
	public void onItemSelected(AdapterView<?> parent, View view,
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.force)[0])) {
		a_txt.setHint(getResources().getStringArray(R.array.force)[1]);
		b_txt.setHint(getResources().getStringArray(R.array.force)[2]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.force)[1])) {
		a_txt.setHint(getResources().getStringArray(R.array.force)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.force)[2]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.force)[2])) {
		a_txt.setHint(getResources().getStringArray(R.array.force)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.force)[1]);
	    }
	}
	...
	public void onClick(View v) {
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.force)[0])) {
		result = Physics.force(Double.NEGATIVE_INFINITY, a, b);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.force)[1])) {
		result = Physics.force(a, Double.NEGATIVE_INFINITY, b);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.force)[2])) {
		result = Physics.force(a, b, Double.NEGATIVE_INFINITY);
	    }
