...
public class TorqueActivity extends FormulaActivity {

    public static final String ACTION_TORQUE = "com.centauri.equations.action.TORQUE";

    @Override
    public void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	getSupportFragmentManager().beginTransaction()
		.add(android.R.id.content, new TorqueFragment()).commit();
    }
	...
	getSupportActionBar().setTitle(R.string.torque);
	getSupportActionBar().setSubtitle(
		getResources().getStringArray(R.array.categories)[4]);
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    public static class TorqueFragment extends FormulaFragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    ((ImageView) getView().findViewById(R.id.img_area))
		    .setImageResource(R.drawable.img_phy_torque);
	    ...
	    a_txt.setHint(getResources().getStringArray(R.array.torque)[1]);
	    b_txt.setHint(getResources().getStringArray(R.array.torque)[2]);
	    c_txt.setHint(getResources().getStringArray(R.array.torque)[3]);
	    c_txt.setVisibility(View.VISIBLE);

	    adapter = ArrayAdapter.createFromResource(getActivity(),
		    R.array.torque, android.R.layout.simple_spinner_item);
	...
	public void onItemSelected(AdapterView<?> parent, View view,
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.torque)[0])) {
		a_txt.setHint(getResources().getStringArray(R.array.torque)[1]);
		b_txt.setHint(getResources().getStringArray(R.array.torque)[2]);
		c_txt.setHint(getResources().getStringArray(R.array.torque)[3]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[1])) {
		a_txt.setHint(getResources().getStringArray(R.array.torque)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.torque)[2]);
		c_txt.setHint(getResources().getStringArray(R.array.torque)[3]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[2])) {
		a_txt.setHint(getResources().getStringArray(R.array.torque)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.torque)[1]);
		c_txt.setHint(getResources().getStringArray(R.array.torque)[3]);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[3])) {
		a_txt.setHint(getResources().getStringArray(R.array.torque)[0]);
		b_txt.setHint(getResources().getStringArray(R.array.torque)[1]);
		c_txt.setHint(getResources().getStringArray(R.array.torque)[2]);
	    }
	}
	...
	public void onClick(View v) {
	    ...
	    if (variable
		    .equals(getResources().getStringArray(R.array.torque)[0])) {
		result = Physics.torque(Double.NEGATIVE_INFINITY, a, b, c);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[1])) {
		result = Physics.torque(a, Double.NEGATIVE_INFINITY, b, c);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[2])) {
		result = Physics.torque(a, b, Double.NEGATIVE_INFINITY, c);
	    } else if (variable.equals(getResources().getStringArray(
		    R.array.torque)[3])) {
		result = Physics.torque(a, b, c, Double.NEGATIVE_INFINITY);
	    }
