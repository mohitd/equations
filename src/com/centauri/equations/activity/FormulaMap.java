...
public class FormulaMap {
    ...
    static {
        ...
        formulaMap.put(40, MaxProjectileHeightActivity.ACTION_MAX_PROJECTILE_HEIGHT);
        formulaMap.put(41, MaxProjectileRangeActivity.ACTION_MAX_PROJECTILE_RANGE);
        ...
        formulaMap.put(53, PhysicsConstantsActivity.ACTION_GRAVITATION_CONSTANT);
        ...
        fragmentMap.put(34, new OneDimensionMotionActivity.OneDimensionMotionFragment());
        fragmentMap.put(35, new ForceActivity.ForceFragment());
        fragmentMap.put(36, new TorqueActivity.TorqueFragment());
        fragmentMap.put(37, new CentripetalForceActivity.CentripetalForceFragment());
        fragmentMap.put(38, new CentripetalAccelActivity.CentripetalAccelFragment());
        fragmentMap.put(39, new GravitationActivity.GravitationFragment());
        fragmentMap.put(40, new MaxProjectileHeightActivity.MaxProjectileHeightFragment());
        fragmentMap.put(41, new MaxProjectileRangeActivity.MaxProjectileRangeFragment());
        ...
        fragmentMap.put(47, new ParticleEnergyActivity.ParticleEnergyFragment());
        ...
        fragmentMap.put(50, new PhysicsConstantsActivity.PlancksConstantFragment());
        fragmentMap.put(51, new PhysicsConstantsActivity.SpeedOfLightFragment());
        fragmentMap.put(52, new PhysicsConstantsActivity.PermittivityFragment());
        fragmentMap.put(53, new PhysicsConstantsActivity.GravitationConstantFragment());
        fragmentMap.put(54, new PhysicsConstantsActivity.GravitationAccelFragment());
