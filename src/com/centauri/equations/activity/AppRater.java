...
public class AppRater {
    ...
    public static void showRateDialog(final Context mContext,
        ...
        Button b1 = new Button(mContext, null, R.attr.buttonBarButtonStyle);
        ...
        Button b2 = new Button(mContext, null, R.attr.buttonBarButtonStyle);
        ...
        Button b3 = new Button(mContext, null, R.attr.buttonBarButtonStyle);
