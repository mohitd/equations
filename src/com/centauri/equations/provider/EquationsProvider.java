    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE IF NOT EXISTS " + FORMULA_TABLE_NAME
                    ...
                    + Equations.Formula.CATEGORY + " TEXT,"
                    + Equations.Formula.FAVORITE + " INTEGER" + ");");
            Resources res = context.getResources();

            // TODO: Instead of this, put this all into a SQLite resource string
            // and then fetch it using the context
        ...
        private long addFormula(SQLiteDatabase db, String formulaName,
            ...
            values.put(Equations.Formula.FORMULA_NAME, formulaName);
            values.put(Equations.Formula.CATEGORY, category);
