...
public class Polynomial implements Cloneable {
    ...
    // The number of base digits in each floating-point number (double
    // precision)
    ...
    // Temporary storage space for complex numbers with real and imaginary
    // parts.
     ...
     * 
     * @param coefficients
     *            An array of real coefficients in order of increasing power.
     **/
     ...
     * 
     * @param x
     *            The generally Complex point at which to evaluate this
     *            polynomial.
     ...
     * 
     * @param x
     *            The real point at which to evaluate this polynomial.
     * @returns The evaluation of this polynomial at x.
     **/
     ...
     * 
     * @param xr
     *            The real component of the point at which to evaluate this
     *            polynomial.
     * @param xi
     *            The imaginary component of the point at which to evaluate this
     *            polynomial.
     ...
     *         polynomial.
     * @throw RootException if there is a problem finding the zeros of the
     *        polynomial.
     **/
     ...
     * Polynomial object that has exactly the same coefficients as this object.
     * 
     * @param obj
     *            The object to be compared with this Polynomial object for
     *            equality.
     * @return True if the argument is not null and is a Polynomial object that
     *         has exactly the same coefficients as this object.
     **/
    ...
    /**
     * <p>
     * Finds all the zeros of a complex polynomial.
     * </p>
     * 
     * <p>
     ...
     * 
     * <p>
     * Ported from FORTRAN to Java by Joseph A. Huwaldt, July 20, 2000
     * </p>
     * 
     * <p>
     * FORTRAN version from <a href="http://www.netlib.org/">Netlib
     * Repository</a> where it is listed as "419.f". A PDF file describing the
     * algorithm and it's history with references is also available from Netlib.
     * </p>
     * 
     * <p>
     ...
     * 
     * @param Pr
     *            Array of real part of the polynomial coefficients in order of
     *            decreasing powers. Will contain garbage after calling this
     *            method!
     * @param Pi
     *            Array of imaginary part of the polynomial coefficients in
     *            order of decreasing powers. Will contain garbage after calling
     *            this method!
     ...
     * 
     * @param NN
     *            The number of coefficients to use in the evaluation.
     * @param Sr
     *            The real component of the point at which to evaluate this
     *            polynomial.
     * @param Si
     ...
     *            polynomial.
     * @param Pr
     *            , Pi Real & Imaginary coefficients of the polynomial.
     * @param Qr
     ...
     *            The number of coefficients to use in the evaluation.
     * @param Qr
     *            Real part of partial sum from evaluate().
     * @param Qi
     *            Imaginary part of partial sum from evaluate().
     * @param MS
     *            Modulus of the point being evaluated.
     * @param MP
     *            Modulus of the polynomial value.
     * @param ARE
     *            Error bounds on complex addition.
     * @param MRE
     *            Error bounds on complex multiplication.
     ...
     * 
     * @param Ar
     *            The real part of the complex numerator.
     * @param Ai
     *            The imaginary part of the complex numerator.
     * @param Br
     *            The real part of the complex denominator.
     * @param Bi
     ...
     *            The number of coefficients to use in the evaluation.
     * @param L1
     *            Number of Level 1 shifts to make.
     * @param Pr
     *            , Pi The coefficients of the polynomial.
     * @param Hr
     ...
     *            The number of coefficients to use in the evaluation.
     * @param Sr
     *            The real part of the point we are evaluating the polynomial
     *            at.
     * @param Si
     *            The imaginary part of the point we are evaluating the
     *            polynomial at.
     * @param Hr
     *            , Hi Arrays containing ?
     * @param QHr
     *            , QHi Arrays containing partial sums of H(S) polynomial.
     ...
     *            The number of coefficients to use in the evaluation.
     * @param bool
     *            Set to true if H(S) is essentially zero.
     * @param Hr
     *            , Hi Arrays containing ?
     * @param QPr
     *            , QPi
